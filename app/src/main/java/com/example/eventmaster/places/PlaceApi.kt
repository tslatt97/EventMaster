...
import com.example.eventmaster.places.Address
import com.example.eventmaster.places.OnPlacesDetailsListener
import com.example.eventmaster.places.Place
import com.example.eventmaster.places.PlaceDetails
...
/*Dette er et API som vi har implementert i koden vår, denne klassen er ikke vår egen.
* Klassen er nødvendig for å hente informasjon om steder som blir valgt i autocompletetextview
* i create-event. APIet henter eventuell informasjon om stedet, som lat/long, lokasjon,
* detaljer og mye mer. Det eneste vi benytter APIet til er å hente ut stedsnavn og latitude/longitude.
* Ytterligere kommentarer i filen er ikke våre.*/
class PlaceAPI private constructor(
    ...
    private fun checkInitialization() {
        if (TextUtils.isEmpty(apiKey)) {
            throw com.example.eventmaster.places.InitializationException(appContext.getString(R.string.error_lib_not_initialized))
        }
    }
    ...
    companion object {
        private val TAG = `in`.madapps.placesautocomplete.PlaceAPI::class.java.simpleName
